...
if __name__ == '__main__':
    ...
    scheduler.add_job(Job('send_daily', dailyReport, None, Periods.minute, 1440, '05.04.23 11:30'))
    scheduler.add_job(Job('send_polls', create_poll, None, Periods.minute, 1440, '05.04.23 11:10'))
    scheduler.add_job(Job('clearIQ', clearIQ, None, Periods.minute, 1440, '05.04.23 08:01'))
