...
if __name__ == '__main__':
    ...
    scheduler.add_job(Job('send_daily', dailyReport, None, Periods.minute, 1440, '02.05.23 11:45'))
    scheduler.add_job(Job('send_polls', create_poll, None, Periods.minute, 1440, '03.05.23 11:10'))
    scheduler.add_job(Job('clearIQ', clearIQ, None, Periods.minute, 1440, '03.04.23 08:00'))
